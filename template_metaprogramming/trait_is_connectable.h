...
struct is_list_compatible<List<From, Froms...>, List<To, Tos...>> {
    static constexpr bool value = is_convertible_v<From, To> && is_list_compatible_v<List<Froms...>, List<Tos...>>;
};
...
struct is_connectable {
    ...
    static constexpr bool value = signal::args_list::size >= slot::args_list::size &&
