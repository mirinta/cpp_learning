...
struct pop_back<LIST<T0, T1, T2toN...>, RET_LIST> : public pop_back<LIST<T1, T2toN...>, push_back_t<RET_LIST, T0>> {};
...
struct any
    : public std::conditional_t<PREDICATE<front_t<LIST>>::value, std::true_type, any<PREDICATE, pop_front_t<LIST>>> {};
